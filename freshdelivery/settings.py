"""
Django settings for freshdelivery project.
...
sys.path.insert(0, os.path.join(BASE_DIR, 'apps'))  # 将应用目录作为加载项
...
ROOT_URLCONF = 'freshdelivery.urls'
...
WSGI_APPLICATION = 'freshdelivery.wsgi.application'
...
AUTH_USER_MODEL = 'user.User'  # 替换自带的auth_user表
